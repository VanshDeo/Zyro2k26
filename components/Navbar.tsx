                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-8">
                            {["Home", "About", "Tracks", "Rewards", "Timeline", "Partners", "FAQ"].map((item) => (
                                <Link
                                    key={item}
                    ...
                    <div className="hidden md:block">
                        <button className="bg-primary text-black font-bold py-2 px-6 rounded-none hover:bg-accent transition-all duration-300 transform hover:scale-105">
                            REGISTER NOW
                        </button>
                    </div>
                ...
                <div className="md:hidden bg-surface border-b border-white/10">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div className="mt-4 px-3">
                            <button className="w-full bg-primary text-black font-bold py-3 rounded-none hover:bg-accent">
                                REGISTER NOW
                            </button>
                        </div>
                    </div>
