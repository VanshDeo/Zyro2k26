        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 text-sm max-w-xs">
              Innovating for a sustainable future. Join us in shaping tomorrow's
              technology.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <a
              key={1}
              href="https://www.linkedin.com/company/kgecrs/posts/"
              target="_blank"
              className="w-10 h-10 rounded-full bg-background border border-white/10 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-black hover:border-primary transition-all duration-300"
            >
              <Linkedin size={18} />
            ...
            <a
              key={3}
              href="https://www.instagram.com/kgec_rs?igsh=MW8yYTNwdTIzdG9mMg=="
              target="_blank"
              className="w-10 h-10 rounded-full bg-background border border-white/10 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-black hover:border-primary transition-all duration-300"
            >
              <Instagram size={18} />
